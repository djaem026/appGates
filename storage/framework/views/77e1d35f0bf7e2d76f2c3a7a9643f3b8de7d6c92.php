<html>
<head>
    <title>Schedule - <?php echo e($ttr->name.' - '.$ttr->year); ?></title>
    <style>
        @media  print {
        ...
        <table width="100%">
            <tr>
                <td >
                    ...
                    <br /> <br />
                    <strong><span style="color: #000; font-size: 15px;"> SCHEDULE FOR <?php echo e(strtoupper($my_class->name. ' ('.$ttr->year.')' )); ?>
...
<?php /**PATH C:\xampp\htdocs\appGate\resources\views/pages/support_team/timetables/print.blade.php ENDPATH**/ ?>