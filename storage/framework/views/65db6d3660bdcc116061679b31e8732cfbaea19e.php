...
<?php $__env->startSection('page_title', 'Manage Schedule Record'); ?>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <ul class="nav nav-tabs nav-tabs-highlight">
                ...
                <li class="nav-item"><a target="_blank" href="<?php echo e(route('ttr.show', $ttr->id)); ?>" class="nav-link" >View Schedule</a></li>
            </ul>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\appGate\resources\views/pages/support_team/timetables/manage.blade.php ENDPATH**/ ?>