    ...
    <div class="card">
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-md-4"><h6 class="card-title"><strong>Year: </strong> <?php echo e(($ttr->exam_id) ? 'Exam Schedule' : 'Class TimeTable'); ?> <?php echo e('('.$ttr->year.')'); ?></h6></div>
            </div>
        </div>
            <div class="card-body">
                ...
                <div class="text-center mt-4">
                    <a target="_blank" href="<?php echo e(route('ttr.print', $ttr->id)); ?>" class="btn btn-danger btn-lg"><i class="icon-printer mr-2"></i> Print Schedule</a>
                </div>
            </div>
        </div>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\appGate\resources\views/pages/support_team/timetables/show.blade.php ENDPATH**/ ?>