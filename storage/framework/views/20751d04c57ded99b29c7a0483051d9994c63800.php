               ...
               <?php echo csrf_field(); ?>
                ...
                <fieldset>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="d-block">Upload ID Photo:</label>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u299472748/domains/appgate.website/public_html/resources/views/pages/support_team/students/add.blade.php ENDPATH**/ ?>